...
std::istream &malanin::operator>>(std::istream &in, yaDataStruct &dest)
{
...
std::ostream &malanin::operator<<(std::ostream &out, const yaDataStruct &src)
{
...
bool malanin::operator<(const yaDataStruct & left, const yaDataStruct & right)
{
