...
std::ostream& malanin::operator<<(std::ostream& out, const DoubleSci&& value)
{
...
std::istream& malanin::operator>>(std::istream& in, DblSci&& value)
{
...
std::istream& malanin::operator>>(std::istream& in, StringStr&& value)
{
  std::istream::sentry guard(in);
  if (!guard)
  {
...
std::istream& malanin::operator>>(std::istream& in, RatLsp&& value)
{
  std::istream::sentry guard(in);
  if (!guard)
  {
