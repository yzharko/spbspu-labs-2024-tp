...
std::istream& malanin::operator>>(std::istream& in, DelimiterString&& exp)
{
...
std::istream& malanin::operator>>(std::istream& in, DelimiterChar&& exp)
{
  std::istream::sentry guard(in);
  if (!guard)
  {
