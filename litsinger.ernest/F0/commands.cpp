...
void litsinger::printCommands(std::ostream& out)
{
  ...
  out << " 8. get_print <name, line> - вывод всех слов из словар€ name, содержащихс€ на строке line\n";
  out << " 9. get_intersection <new_name, name> - создание словар€ new_name со словами из словар€ name\n";
  out << " 10. search_letter <letter, name> вывод слов, которые начинаютс€ на букву letter в словаре name\n";
}
...
void litsinger::getIntersection(mapDictionaries_t& mapDictionaries, std::istream& in, std::ostream& out)
{
  ...
  if (newname != name)
  {
    ...
    {
      out << " ќшибка: либо словарь '" << name << "' не существует, либо словарь '" << newname << "'уже зан€т\n";
    }
  }
  else
  {
    out << " Ќазвани€ старого и нового словар€ одинаковы, введите другое название нового словар€\n";
  }
}
