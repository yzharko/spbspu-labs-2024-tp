...
std::istream & uzun::operator>>(std::istream &in, DataStruct &value)
{
...
std::ostream & uzun::operator<<(std::ostream & out, const DataStruct &value)
{
...
bool uzun::operator>(const DataStruct &left, const DataStruct &right)
{
