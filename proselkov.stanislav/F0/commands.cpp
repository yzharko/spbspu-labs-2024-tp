...
{
  out << "Список команд:\n";
  out << "1. help - вывод списка всех доступных команд и их описание.\n";
  out << "2. create <name> - создание словаря с именем name.\n";
  out << "3. remove <name> - удаление словаря с именем name.\n";
  out << "4. print <name> - вывод содержимого словаря с именем name. Если словарь пуст, то команда выводит сообщение <EMPTY>.\n";
  ...
  out << "11. combine <name1> <name2> <new_name> - создание нового словаря new_name с объединением всех слов из словарей name1 и name2.\n";
