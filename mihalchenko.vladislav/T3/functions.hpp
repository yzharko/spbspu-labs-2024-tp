...
namespace mihalchenko
{
  ...
  void printArea(const std::vector<Polygon> &polygons, std::ostream &out, std::istream &is);
  ...
  void printMax(const std::vector<Polygon> &polygons, std::ostream &out, std::istream &is);
  ...
  void printMin(const std::vector<Polygon> &polygons, std::ostream &out, std::istream &is);
  ...
  void printCount(const std::vector<Polygon> &polygons, std::ostream &out, std::istream &is);
  ...
  void printPerms(const std::vector<Polygon> &polygon, std::ostream &out, std::istream &is);
