...
namespace sobolevsky
{
  ...
  void getLoadAndCreate(std::shared_ptr< std::vector< std::pair< std::string, std::multimap< size_t, std::string > > > > myVec, std::istream & in, std::ostream & out);
  void getDelete(std::shared_ptr< std::vector< std::pair< std::string, std::multimap< size_t, std::string > > > > myVec, std::istream & in, std::ostream & out);
  void getAllDicts(std::shared_ptr< std::vector< std::pair< std::string, std::multimap< size_t, std::string > > > > myVec, std::istream & in, std::ostream & out);
  void getSelect(std::shared_ptr< std::vector< std::pair< std::string, std::multimap< size_t, std::string > > > > myVec, std::istream & in, std::ostream & out);
  ...
  void getRename(std::shared_ptr< std::vector< std::pair< std::string, std::multimap< size_t, std::string > > > > myVec, std::istream & in, std::ostream & out);
