...
namespace sobolevsky
{
  ...
  void getLoadAndCreate(std::shared_ptr< std::vector< mypair > > myVec, std::istream & in, std::ostream & out);
  void getDelete(std::shared_ptr< std::vector< mypair > > myVec, std::istream & in, std::ostream & out);
  ...
  void getRename(std::shared_ptr< std::vector< mypair > > myVec, std::istream & in, std::ostream & out);
