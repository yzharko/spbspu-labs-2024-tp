...
std::istream& maksimov::operator>>(std::istream& in, DataStruct& value)
{
...
std::ostream& maksimov::operator<<(std::ostream& out, const DataStruct& value)
{
...
bool maksimov::operator<(const DataStruct& value1, const DataStruct& value2)
{
