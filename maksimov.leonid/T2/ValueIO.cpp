...
std::istream& maksimov::operator>>(std::istream& in, DoubleI&& dest)
{
...
std::ostream& maksimov::operator<<(std::ostream& out, const DoubleO&& exp)
{
...
std::istream& maksimov::operator>>(std::istream& in, UnsignedllI&& exp)
{
  std::istream::sentry guard(in);
  if (!guard)
  {
...
std::istream& maksimov::operator>>(std::istream& in, StringI&& dest)
{
  std::istream::sentry guard(in);
  if (!guard)
  {
