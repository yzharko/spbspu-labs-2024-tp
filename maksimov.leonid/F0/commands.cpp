...
std::string maksimov::statusString(std::string msg, std::string status)
{
  return "[" + status + "] " + msg;
}

std::string maksimov::prompt(std::string active)
{
  return active == "" ? "menu> " : "(" + active + ")> ";
}

std::ostream & maksimov::commands::help(std::istream & in, std::ostream & out)
{
  if (in.peek() != '\n')
  {
...
std::ostream & maksimov::commands::list(strings_t & strings, std::istream & in, std::ostream & out)
{
  if (in.peek() != '\n')
  {
    throw std::logic_error(statusString("No additional args allowed\n", "warn"));
...
std::ostream & maksimov::commands::rm(strings_t & strings, std::istream & in, std::ostream & out)
{
...
std::ostream & maksimov::commands::create(strings_t & strings, std::istream & in, std::ostream & out)
{
...
std::ostream & maksimov::commands::cmp(strings_t & strings, std::istream & in, std::ostream & out)
{
  std::string l1 = "";
  in >> l1;
  if (!in)
...
bool maksimov::hasWord(const wordpairs_t & ref, const std::string word)
{
  return ref.find(word) != ref.end();
}

std::ostream & maksimov::commands::diff(strings_t & strings, std::istream & in, std::ostream & out)
{
  std::string l1 = "";
  in >> l1;
  if (!in)
...
bool maksimov::hasNoWord(const wordpairs_t & ref, const std::string word)
{
  return ref.find(word) == ref.end();
}

std::ostream & maksimov::commands::enter(strings_t & strings, std::string & active, std::istream & in, std::ostream & out)
{
  if (active != "")
  {
...
std::ostream & maksimov::commands::read(strings_t & strings, std::string & active, std::istream & in, std::ostream & out)
{
  if (active == "")
  {
...
std::ostream & maksimov::commands::table(strings_t & strings, std::string & active, std::istream & in, std::ostream & out)
{
  if (active == "")
  {
    throw std::logic_error(statusString("Not in string mode\n", "error"));
...
std::ostream & maksimov::commands::info(strings_t & strings, std::string & active, std::istream & in, std::ostream & out)
{
  std::string word = "";
  in >> word;
...
std::ostream & maksimov::commands::stats(strings_t & strings, std::string & active, std::istream & in, std::ostream & out)
{
  if (in.peek() != '\n')
  {
    throw std::logic_error(statusString("No additional args allowed\n", "warn"));
...
std::ostream & maksimov::commands::quit(std::string & active, std::istream & in, std::ostream & out)
{
  if (in.peek() != '\n')
  {
    throw std::logic_error(statusString("No additional args allowed\n", "warn"));
...
std::string maksimov::extractKeyFromStringsPair(const std::pair< std::string, string_t > & pair)
{
  return pair.first;
}

std::string maksimov::extractKeyFromWordpair(const std::pair< std::string, wordpair_t > & pair)
{
  return pair.first;
}

std::string maksimov::coordsToPairs(const wordcoord_t & wordCoord)
{
  return std::to_string(wordCoord.first) + ';' + std::to_string(wordCoord.second);
}

std::string maksimov::wordEntryToString(const std::pair< std::string, wordpair_t >& pair)
{
