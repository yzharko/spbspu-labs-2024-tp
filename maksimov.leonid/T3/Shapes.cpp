...
bool maksimov::comparePoints(const Point& point1, const Point& point2)
{
  return (point1.x == point2.x) && (point1.y == point2.y);
}

bool maksimov::comparePolygonPointsSize(const Polygon& polygon1, const Polygon& polygon2)
{
  return polygon1.points.size() < polygon2.points.size();
}

double maksimov::getArea(const Polygon& polygon)
{
...
double maksimov::CountArea::operator()(double area, const Point& point2, const Point& point3)
{
...
bool maksimov::Polygon::hasRightAngle() const
{
...
bool maksimov::CountAngle::operator()(const Point& point3)
{
...
std::istream& maksimov::operator>>(std::istream& in, Point& point)
{
...
std::istream& maksimov::operator>>(std::istream& in, Polygon& polygon)
{
  std::istream::sentry guard(in);
  if (!guard)
  {
