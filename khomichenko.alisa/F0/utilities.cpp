...
bool khomichenko::is_inside(const std::pair< std::string, std::list< std::string > > & pair, const unit_t & second)
{
  return second.find(pair.first) != second.cend();
}

bool khomichenko::not_inside(const std::pair< std::string, std::list< std::string > > & pair, const unit_t & second)
{
  return second.find(pair.first) == second.cend();
}

void khomichenko::process_operations(khomichenko::dict_t & dictionaries, std::istream & input, func_t operation)
{
  std::string new_name;
...
khomichenko::unit_t khomichenko::intersect_impl(const unit_t & first, const unit_t & second)
{
  unit_t inter_dict;
...
khomichenko::unit_t khomichenko::union_impl(const unit_t & first, const unit_t & second)
{
  unit_t union_dict;
...
std::ostream & khomichenko::print_pair(const pair_t & pair, std::ostream & output)
{
  output << pair.first << " ";
...
std::ostream & khomichenko::print_dict_impl(const dpair_t & pair, std::ostream & output)
{
  output << pair.first << '\n';
...
std::ostream & khomichenko::operator<<(std::ostream & output, const unit_t & dict)
{
