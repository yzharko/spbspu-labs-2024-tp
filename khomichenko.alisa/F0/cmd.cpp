...
void khomichenko::create_dict(dict_t & dictionaries, std::istream & input)
{
  unit_t content;
  std::string name;
  input >> name;
...
void khomichenko::delete_dict(dict_t & dictionaries, std::istream & input)
{
  std::string name;
  input >> name;
  if (dictionaries.find(name) == dictionaries.end())
...
void khomichenko::add_key(dict_t & dictionaries, std::istream & input)
{
  std::string name;
  std::string key;
  std::string value;
...
void khomichenko::add_value(dict_t & dictionaries, std::istream & input)
{
  std::string name;
  std::string key;
  std::string value;
...
void khomichenko::remove_key(dict_t & dictionaries, std::istream & input)
{
  std::string name;
  std::string key;
...
void khomichenko::print_dict(const dict_t & dictionaries, std::istream & input, std::ostream & output)
{
  std::string name;
  input >> name;
...
void khomichenko::get_value(const dict_t & dictionaries, std::istream & input, std::ostream & output)
{
  std::string name;
  std::string key;
  input >> name >> key;
...
void khomichenko::save(const dict_t & dictionaries, std::istream &input)
{
...
void khomichenko::read(dict_t & dictionaries, std::istream & input)
{
...
void khomichenko::renamedict(dict_t & dictionaries, std::istream & input)
{
  std::string name;
  std::string new_name;
  input >> name >> new_name;
...
void khomichenko::intersect(dict_t & dictionaries, std::istream & input)
{
  process_operations(dictionaries, input, intersect_impl);
}

void khomichenko::uniond(dict_t & dictionaries, std::istream & input)
{
