...
std::istream& panov::operator>>(std::istream& is, DataStruct& value)
{
...
std::ostream& panov::operator<<(std::ostream& out, const DataStruct& value)
{
...
bool panov::operator>(const DataStruct& left, const DataStruct& right)
{
