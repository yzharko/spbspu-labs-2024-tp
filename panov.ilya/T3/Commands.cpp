...
void panov::makeArea(const std::vector< Polygon >& poly, std::istream& in, std::ostream& out)
{
  double result = 0.0;
  std::string arg;
  in >> arg;
...
void panov::makeMax(const std::vector< Polygon >& poly, std::istream& in, std::ostream& out)
{
  std::string arg;
  in >> arg;
...
void panov::makeMin(const std::vector< Polygon >& poly, std::istream& in, std::ostream& out)
{
  std::string arg;
  in >> arg;
  std::map< std::string, std::function< void(std::ostream&) > > subcom;
...
void panov::makeCount(const std::vector< Polygon >& poly, std::istream& in, std::ostream& out)
{
  using namespace std::placeholders;
  std::string arg;
  in >> arg;
...
void panov::makePerms(const std::vector< Polygon >& poly, std::istream& in, std::ostream& out)
{
  Polygon fig;
  in >> fig;
...
void panov::makeRmecho(std::vector< Polygon >& poly, std::istream& in, std::ostream& out)
{
  Polygon polygon;
  in >> polygon;
