...
std::istream& panov::operator>>(std::istream& in, Point& point)
{
...
bool panov::operator==(const Point& point1, const Point& point2)
{
  return (point1.x == point2.x && point1.y == point2.y);
}

std::istream& panov::operator>>(std::istream& in, Polygon& poly)
{
  std::istream::sentry guard(in);
  if (!guard)
  {
...
double panov::getArea(const Polygon& polygon)
{
...
double panov::getAreaPolygons(const std::vector< Polygon >& poly)
{
...
bool panov::isPointIn(const Point& point, const Polygon& poly)
{
...
bool panov::isEqual(const Polygon& p1, const Polygon& p2)
{
